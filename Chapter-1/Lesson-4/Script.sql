...
-- pattern 
-- select the records where name start with "Al"
select * from students where name like "Al%";

-- contains
select * from students where department like "%en%";

-- "_" means any 1 character 
select * from students where name like "_li%";

select * from students where name like "A_e%";
...
insert into customers values(101, "Alex", "Pune"),
(102, "Karan", "Banglore"),
(103, "Isha", "Pune"),
(104, "Alaya", "Banglore")
...
insert into orders values(1, 8998090, 101),
(2, 80909, 102),
(3, 80908099, 101),
(4, 98980, 103),
(5, 80909, 102)
...
-- give error: this is is present on order table 
...
delete from orders where customer_id in (1, 2, 4, 5, 6)
...
-- inner join 
select cust.first_name, cust.last_name, ord.order_id 
