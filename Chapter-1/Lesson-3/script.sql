...
-- give error of duplicate primary key 
-- insert into users values(2, "Alex", 20, "alex@gmail.com", "11-11-26");

insert into users(ID, name, age, email) values(5, "Alaya", 20, "alaya@gmail.com");

-- error of primary key
-- insert into users(ID, name, age, email) values(null, "Alaya", 20, "alaya@gmail.com");

select * from users where email = "alaya@gmail.com";
...
insert into customers(name, age, email) values("Alex", 20, "alex@gmail.com");
insert into customers(name, age, email) values("Alina", 10, "alina@gmail.com");
...
CREATE TABLE users (
    u Pser_id INTRIMARY KEY AUTO_INCREMENT,
...
select * from employee order by position asc, employee_id desc;

-- limit 
select * from employee order by employee_id desc limit 3;

-- select 5 records after 5th record  
select * from employee limit 5 offset 5;

-- Aggregate function
select count(*) from employee where position = "Developer";
...
-- sum between 2 columns
select sum(price + stock_quantity) as totalColumn from products;

-- sum between 2 columns for each row 
select price, stock_quantity, (price + stock_quantity) as totalVal from products;

-- group by 
select * from employee

select count(employee_id), position from employee group by position;

-- count of customer in each address
...
-- count of orderbs by each customer 
